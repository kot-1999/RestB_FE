...
export default class ApiRequest {
    ...
    // ✅ FIXED: Renamed back to getBookingSummaries to match bookingsManage.js
    static async getBookingSummaries(queryParams = {}) {
        try {
            ...
            const response = await fetch(url, {
                headers: ApiRequest.getHeaders(authData),
                method: "GET",
            });
        ...
        try {
            ...
            if (isAdmin && restaurantID) {
                ...
                if (queryParams.statuses && Array.isArray(queryParams.statuses)) {
                    queryParams.statuses.forEach(s => params.append('statuses[]', s));
                }
